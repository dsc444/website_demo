...
export default function SuccessPage() {
  ...
  return (
    <div className="relative min-h-[80vh] flex flex-col items-center justify-center p-6 overflow-hidden bg-zinc-950">
      ...
      <div className="absolute top-0 left-0 p-6">
        ...
        >
          <svg className="transform group-hover:-translate-x-1 transition-transform" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6"/></svg>
          Back to Market
        </Link>
      </div>
      ...
      <div className="text-center space-y-8 animate-in fade-in zoom-in duration-700">
        ...
        <div className="relative mx-auto w-32 h-32 bg-zinc-900 rounded-full flex items-center justify-center shadow-2xl border border-zinc-800">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px]">
              {isProcessing ? "Sending Notifications..." : "Transaction Successful"}
            </p>
            <div className="h-1 w-12 bg-zinc-800 rounded-full" />
            <p className="text-zinc-500 font-medium max-w-sm mx-auto leading-relaxed">
              Your order is being processed. We’ve sent a digital receipt to your email address and notified the warehouse.
            </p>
          </div>
        </div>
        ...
        <div className="pt-6">
          <Link 
            href="/dashboard/profile" 
            className="inline-block bg-white text-black font-black px-14 py-5 rounded-2xl hover:bg-emerald-400 hover:scale-105 transition-all active:scale-95 shadow-2xl"
          >
            CONTINUE SHOPPING
          </Link>
        </div>
